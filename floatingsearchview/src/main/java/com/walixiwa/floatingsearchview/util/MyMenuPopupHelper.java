package com.walixiwa.floatingsearchview.util;
...
import com.walixiwa.floatingsearchview.R;
...
public class MyMenuPopupHelper implements AdapterView.OnItemClickListener, View.OnKeyListener,
        ViewTreeObserver.OnGlobalLayoutListener, PopupWindow.OnDismissListener,
        MenuPresenter {
    private static final String TAG = "MenuPopupHelper";
    static final int ITEM_LAYOUT = R.layout.menu_list_layout;
    ...
    public MyMenuPopupHelper(Context context, MenuBuilder menu) {
        this(context, menu, null, false, R.attr.popupMenuStyle);
    }

    public MyMenuPopupHelper(Context context, MenuBuilder menu, View anchorView) {
    ...
    public MyMenuPopupHelper(Context context, MenuBuilder menu, View anchorView,
        ...
        mPopupMaxWidth = Math.max(res.getDisplayMetrics().widthPixels / 2, res.getDimensionPixelSize(R.dimen.abc_config_prefDialogWidth));
    ...
    public boolean onSubMenuSelected(SubMenuBuilder subMenu) {
        if (subMenu.hasVisibleItems()) {
            MyMenuPopupHelper subPopup = new MyMenuPopupHelper(mContext, subMenu, mAnchorView);
